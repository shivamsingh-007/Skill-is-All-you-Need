/**
 * Slop Detection Pipeline - Detection Only
 *
 * SECURITY NOTE: This file SCANS for slop patterns in code.
...
function formatHandoffPrompt(findings, mode, options = {}) {
  ...
  output += `- Auto-fixable: ${autoFixable.length}\n`;
  output += `- Needs manual review: ${needsReview.length}\n`;
