---
name: SKILL.md
description: Use this skill when auditing a project for security, performance, or code quality issues. Do not use for feature development.
---
...
Or use the multi-agent review system directly:

```bash
node lib/index.js --path /your/project
```
