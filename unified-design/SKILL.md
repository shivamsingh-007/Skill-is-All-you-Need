...
| Anti-slop frontend (landing/portfolio) | `design-taste-frontend` | External skill |
| Logo creation, AI generation | Logo (built-in) | `references/logo-design.md` |
| CIP mockups, deliverables | CIP (built-in) | `references/cip-design.md` |
| Presentations, pitch decks | Slides (built-in) | See below |
| Banners, covers, headers | Banner (built-in) | See below |
