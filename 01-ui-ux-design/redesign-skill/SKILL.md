...
description: >
  Use this skill when upgrading existing websites to premium quality, auditing current design, and applying high-end standards.
  Do not use for greenfield builds or backend refactoring.
triggers:
